    ...
    - **Always include a plain-language summary** at the end of any response that delivers work (task closeout, feature, bugfix, refactor). The summary should answer in accessible terms: **o que foi feito**, **por que foi feito**, **pra que serve** (qual problema real resolve / qual capacidade habilita). Escreve pensando em alguém que não abriu o diff — sem nome de arquivo, sem jargão de implementação. É complementar ao bloco técnico, não substitui. Uma seção curta (2-4 frases) basta.
